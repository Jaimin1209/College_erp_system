    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                PreparedStatement ps = conn.prepareStatement("UPDATE ADMIN_DEPT SET DNAME=?, DCODE=? WHERE DID=?");
                ...
                response.sendRedirect(
                        ...
                        + "/admin_module/department.jsp?success=Department updated successfully");

            } catch (Exception e) {
                e.printStackTrace();
                response.sendRedirect(
                        request.getContextPath()
                        + "/admin_module/department.jsp?error=Update failed");
            }
